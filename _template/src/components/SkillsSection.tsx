import { Cloud, Server, Database, Shield, Terminal, GitBranch } from "lucide-react";
...
const SkillBar = ({ name, level, icon: Icon }: { name: string; level: number; icon: typeof Cloud }) => (
